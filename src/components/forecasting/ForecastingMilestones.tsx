...
import { projectWealth, getMilestones, getKeyStats, type ScenarioKey, scenarios } from "@/lib/forecasting";
    ...
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginBottom: 16 }}>
      ...
      <div className="mali-card">
        <div style={{ padding: "18px 20px 14px", borderBottom: "1px solid var(--mali-slate-50)" }}>
          <div style={{ fontSize: 14, fontWeight: 500, color: "var(--mali-slate-900)" }}>10-Year Summary</div>
      ...
      <div className="mali-card">
        <div style={{ padding: "18px 20px 14px", borderBottom: "1px solid var(--mali-slate-50)" }}>
          <div style={{ fontSize: 14, fontWeight: 500, color: "var(--mali-slate-900)" }}>Wealth Milestones</div>
          <div style={{ fontSize: 11, color: "var(--mali-slate-400)", marginTop: 2 }}>
        ...
        <div style={{ padding: "16px 20px" }}>
              ...
              {milestones.map((m, i) => (
                <div
                  ...
                  style={{
                    ...
                    borderRadius: 10,
                    border: i === 0 ? "1px solid var(--mali-emerald-muted)" : "1px solid var(--mali-slate-100)",
                  }}
                >
                  <div
                    style={{
                  ...
                  <div style={{ flex: 1 }}>
                    <div style={{ fontSize: 13, fontWeight: 500, color: "var(--mali-slate-900)" }}>{m.label}</div>
                    <div style={{ fontSize: 11, color: "var(--mali-slate-400)", marginTop: 2 }}>
                      Projected: {m.year}
                    </div>
                  </div>
          ...
          >
            <strong style={{ color: "var(--mali-gold)", fontWeight: 500 }}>Increase your savings rate</strong> by just 5% to reach these milestones 1–2 years earlier. Switch to the Optimistic scenario to see the impact.
          </div>
        </div>
      </div>
