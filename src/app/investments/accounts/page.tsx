          ...
          {accounts.map((acc) => {
            ...
            return (
              ...
              >
                ...
                {/* Name + institution */}
                <div style={{ fontSize: 15, fontWeight: 500, color: "var(--mali-slate-900)", marginBottom: 2 }}>
                  {acc.name}
                </div>
                <div style={{ fontSize: 12, color: "var(--mali-slate-400)", marginBottom: 16 }}>
                  {acc.institution}
                </div>
